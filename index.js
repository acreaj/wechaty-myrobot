...
// async function timingSchedule(){
//   schedule.scheduleJob('30 * * * * *', async () => {
//     let contact = await bot.Room().find({ name: 'robot' })
//     // let contactonor = await bot.Contact.find({ name: 'onor' })
//     try {
//       await contact.say('123') // 发送消息
//       // await contactonor.say('123')
//     } catch (e) {
